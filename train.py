...
def main(args):
    ...
    data_loader = TrainDataLoader(input_dir=args.input_dir, is_transform=True, img_size=args.img_size,
                                  kernel_num=kernel_num, min_scale=min_scale)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', nargs='?', type=str, default='../data/ICDAR2017/',
